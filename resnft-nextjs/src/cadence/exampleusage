...
function App() {
  ...
  const createNFTsale = async () => {
    const transactionID = await fcl
      .send([
        ...
        fcl.args([fcl.arg(saleNFTid, fcl.t.UInt64), fcl.arg(salePrice, fcl.t.UFix64)]),
        fcl.payer(fcl.authz),
  ...
  const purchaseNFT = async () => {
    const transactionID = await fcl
      .send([
        ...
        fcl.args([fcl.arg(buyaddr, fcl.t.Address), fcl.arg(buyNFTid, fcl.t.UInt64), fcl.arg(buyPrice, fcl.t.UFix64)]),
        fcl.payer(fcl.authz),
        fcl.proposer(fcl.authz),
        fcl.authorizations([fcl.authz]),
        fcl.limit(9999),
  ...
  const sendflowtokens = async () => {
    const transactionID = await fcl
      .send([
        ...
        fcl.args([fcl.arg(flowSendAddress, fcl.t.Address), fcl.arg(flowSendAmount, fcl.t.UFix64)]),
        fcl.payer(fcl.authz),
        fcl.proposer(fcl.authz),
        fcl.authorizations([fcl.authz]),
        fcl.limit(9999),
  ...
  return (
    <div className="App">
      ...
      <p> ----------------------</p>
      <button onClick={() => getFlowBalanceFunction()}> Get Flow Balance </button>
      <p> Flow Balance : {flowBalance} </p>
      <p> ----------------------</p>
      <input type="text" placeholder="Enter Amount to Send" value={flowSendAmount} onChange={(e) => setFlowsendamount(e.target.value)} />
      <p></p>
      <input type="text" placeholder="Enter Address to Send" value={flowSendAddress} onChange={(e) => setFlowsendaddress(e.target.value)} />
      <p></p>
      ...
      <input type="text" placeholder="Enter Price to Sell" value={salePrice} onChange={(e) => setSalePrice(e.target.value)} />
      <button onClick={() => createNFTsale()}> Create NFT Sale </button>

      <p> ----------------------</p>
      <input type="text" placeholder="Enter Address to Buy" value={buyaddr} onChange={(e) => setBuyaddr(e.target.value)} />
      <input type="text" placeholder="Enter NFT ID to Buy" value={buyNFTid} onChange={(e) => setBuyNFTid(e.target.value)} />
      <input type="text" placeholder="Enter Price to Buy" value={buyPrice} onChange={(e) => setBuyPrice(e.target.value)} />
      <button onClick={() => purchaseNFT()}> Purchase NFT </button>

      <p> ----------------------</p>
      <input type="text" placeholder="Enter Address to Query" value={salequeryaddr} onChange={(e) => setSalequeryaddr(e.target.value)} />
