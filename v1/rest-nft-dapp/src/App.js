...
function App() {
  ...
  const mintNFT = async () =>{
    const transactionID = await fcl.send([
      ...
      fcl.args([fcl.arg(mintData, fcl.t.String), fcl.arg(mintBond, fcl.t.UInt64), fcl.arg(mintRoyalties, fcl.t.UFix64), fcl.arg(mintName, fcl.t.String)]),
      fcl.payer(fcl.authz),
